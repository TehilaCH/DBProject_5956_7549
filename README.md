...
הפשטת “אירועים” ל‑Superclass אחת
...
זה מאפשר לדווח ולנתח אירועים מכל הסוגים באותה טבלה היסטורית או לחבר דוחות רוחביים.

יישות קשר אסוציאטיבית במקום מעוינים מורכבים
