...
מסכים זמינים במערכת:
מסך ראשי – מאפשר גישה לכל מסכי המערכת- כפתורים לניהול טבלת מבצעים,טבלת ציוד וטבלת דרושים וכן כפתור למסך הפעלת פונקציה, פורצדורה ושאילתא על המסד נתונים.

ניהול מבצעים (Operation) – מאפשר הוספה, עדכון, מחיקה ושליפה של מבצעים.

ניהול ציוד (Equipment) – CRUD על טבלת הציוד.

ניהול ציוד נדרש (Requires) – טבלה מקשרת בין ציוד למבצעים.

שאילתות ופרוצדורות – הצגת פלטים מתוך פונקציות/פרוצדורות כולל:
